...
if (isset($_POST['ubah'])) {
    ...
    $nip = $this->request->getPost('nip');
    $db_nip = $this->guru_m->getAllData($id);
    ...
    $rules = [
        ...
        'nip' => [
            ...
            'rules' => 'required|numeric' . ($nip !== $db_nip ? '|is_unique[guru.nip]' : ''),
        ],
        'nama' => [
            'label' => 'Nama guru',
            'rules' => 'required'
    ...
    if (!$this->validate($rules)) {
        ...
        // Ambil file gambar
        $gambar = $this->request->getFile('gambar');
        $currentGambar = $this->guru_m->getAllData($id); // Ambil nama gambar yang sudah ada di database
